...
import { MyinfoScreenStyles as styles, headerStyles } from "./MyinfoScreen.styles";
...
type Props = StackScreenProps<MypageStackParamList, "Myinfo">;

export default function MyinfoScreen({ navigation, route }: Props) {
  ...
  return (
      <View style={styles.container}>
        <View style={headerStyles.container}>
          <Pressable style={headerStyles.backBtn} onPress={handleBack}>
            <UndoIcon width={20} height={20} />
          </Pressable>
          <Text style={headerStyles.title}>맞춤 정보</Text>
