...
const DateScroll = ({
  ...
  const initialYearIndex = YEARS.indexOf(currentYear);
  const initialMonthIndex = MONTHS.indexOf(currentMonth);
          ...
          <View style={dateStyles.pickerContent}>
            ...
            <View style={dateStyles.scrollWrapper}>
              <FlatList
                ...
                initialScrollIndex={initialMonthIndex !== -1 ? initialMonthIndex : 0}
                contentContainerStyle={{ paddingVertical: (211 - ITEM_HEIGHT) / 2 }}
                renderItem={({ item }) => (
                  <Text
